...
#include "OpenAPIAssetsResponse.h"
...
void OpenAPIAssetsResponse::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIAssetsResponse::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
