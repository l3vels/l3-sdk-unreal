...
#include "OpenAPIMintInputAsset.h"
...
void OpenAPIMintInputAsset::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIMintInputAsset::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
