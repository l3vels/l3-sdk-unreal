...
FHttpRequestPtr OpenAPIDefaultApi::ChatControllerWebhook(const ChatControllerWebhookRequest& Request, const FChatControllerWebhookDelegate& Delegate /*= FChatControllerWebhookDelegate()*/) const
{
	...
	HttpRequest->OnProcessRequestComplete().BindRaw(this, &OpenAPIDefaultApi::OnChatControllerWebhookResponse, Delegate);
	HttpRequest->ProcessRequest();
	return HttpRequest;
}

void OpenAPIDefaultApi::OnChatControllerWebhookResponse(FHttpRequestPtr HttpRequest, FHttpResponsePtr HttpResponse, bool bSucceeded, FChatControllerWebhookDelegate Delegate) const
{
	ChatControllerWebhookResponse Response;
	HandleResponse(HttpResponse, bSucceeded, Response);
	Delegate.ExecuteIfBound(Response);
}
