...
#include "OpenAPISetContractUriDto.h"
...
void OpenAPISetContractUriDto::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPISetContractUriDto::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
