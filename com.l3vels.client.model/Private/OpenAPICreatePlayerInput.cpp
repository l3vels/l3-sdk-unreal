...
#include "OpenAPICreatePlayerInput.h"
...
void OpenAPICreatePlayerInput::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPICreatePlayerInput::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
