...
#include "OpenAPIUpdateAssetDto.h"
...
void OpenAPIUpdateAssetDto::WriteJson(JsonWriter& Writer) const
{
...
bool OpenAPIUpdateAssetDto::FromJson(const TSharedPtr<FJsonValue>& JsonValue)
{
