...
#include "com.l3vels.client.model/OpenAPIMintInputAsset.h"
 ...
 * 
 */
class OPENAPI_API OpenAPIMintInput : public Model
{
public:
    virtual ~OpenAPIMintInput() {}
